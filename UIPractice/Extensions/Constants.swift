...
enum Icons {
    static let feeds            = UIImage(systemName: "hand.tap")
    static let feedsSelected    = UIImage(systemName: "hand.tap.fill")
    static let reports          = UIImage(systemName: "rectangle.stack")
